class FacilityProfile {
  ...
  populateForm(data) {
    ...
    if (data.contacts && Array.isArray(data.contacts)) {
      ...
      this.populateContact("facility_incharge", contactMap.facility_incharge || {})
      this.populateContact("registry_focal_person", contactMap.registry_focal_person || {})
      this.populateContact("alt_registry_focal_person", contactMap.alt_registry_focal_person || {})
    }
  ...
  collectFormData() {
    return {
      ...
      contacts: {
        ...
        alt_registry_focal_person: this.getContactData("alt_registry_focal_person"),
      },
      identification: {
