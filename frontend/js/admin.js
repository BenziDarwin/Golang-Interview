$(document).ready(function() {
  ...
  const mockData = {
    diagnosis: [
      { id: 1, name: 'Clinical Diagnosis', code: 'CLIN', description: 'Diagnosis based on clinical examination', active: true },
      { id: 2, name: 'Pathological Diagnosis', code: 'PATH', description: 'Diagnosis confirmed by pathology', active: true },
      { id: 3, name: 'Radiological Diagnosis', code: 'RAD', description: 'Diagnosis based on imaging studies', active: true }
    ],
    cancer: [
      { id: 1, name: 'Breast Cancer', code: 'BRST', description: 'Malignant neoplasm of breast tissue', active: true },
      { id: 2, name: 'Lung Cancer', code: 'LUNG', description: 'Malignant neoplasm of lung tissue', active: true },
      { id: 3, name: 'Colorectal Cancer', code: 'CLRC', description: 'Malignant neoplasm of colon or rectum', active: true }
    ],
    locations: [
      { id: 1, name: 'Breast', code: 'C50', description: 'Breast tissue', active: true },
      { id: 2, name: 'Lung', code: 'C34', description: 'Lung and bronchus', active: true },
      { id: 3, name: 'Colon', code: 'C18', description: 'Large intestine', active: true }
    ],
    treatments: [
      { id: 1, name: 'Surgery', code: 'SURG', description: 'Surgical intervention', active: true },
      { id: 2, name: 'Chemotherapy', code: 'CHEM', description: 'Chemical therapy', active: true },
      { id: 3, name: 'Radiation', code: 'RAD', description: 'Radiation therapy', active: true }
    ],
    facilities: [
      { id: 1, name: 'Hospital', code: 'HOSP', description: 'Full-service medical facility', active: true },
      { id: 2, name: 'Clinic', code: 'CLIN', description: 'Outpatient medical facility', active: true },
      { id: 3, name: 'Laboratory', code: 'LAB', description: 'Medical testing facility', active: true }
    ]
  };
  ...
  function loadItems(category) {
    const items = JSON.parse(localStorage.getItem(`registry_${category}`) || '[]');
  ...
  function addItem(type, data) {
    ...
    if (items.some(item => item.code === data.code)) {
      alert('An item with this code already exists. Please use a different code.');
      return;
    }
